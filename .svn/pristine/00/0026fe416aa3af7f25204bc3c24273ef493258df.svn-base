...
$(document).ready(function() {
	...
	nhn.husky.EZCreator.createInIFrame({
		...
		elPlaceHolder : "answerCn", // 에디터가 그려질 textarea ID 값과 동일 해야 함.
...
function fn_egov_updt_qnacnanswer(form, qaId){
	...
	oEditors.getById["answerCn"].exec("UPDATE_CONTENTS_FIELD", []);
                ...
                <div class="search_top_table">                  
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="Q&amp;A에 대한 답변을 수정합니다.">
					  ...
					  <tr> 
					    ...
					    <td class="td_content">${result.qestnCn}</td>
					  </tr> 
					  ...
					  <tr> 
					    ...
					    <td class="td_content">    
					      <textarea id="answerCn" name="answerCn" cols="95" rows="10" cssClass="txaClass" title="답변내용">${result.answerCn }</textarea>   
