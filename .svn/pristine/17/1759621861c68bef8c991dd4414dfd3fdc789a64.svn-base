...
private EgovLoginService loginService;
	...
	public String selectBBSUseInfs(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model,  HttpSession session, HttpServletResponse response
) throws Exception {
	...
	public String selectBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		if ("SYSTEM_DEFAULT_BOARD".equals(vo.getTrgetId())) {
			...
			vo.setProvdUrl_User("/selectBoardList_user.do?bbsId=" + vo.getBbsId());
		}
