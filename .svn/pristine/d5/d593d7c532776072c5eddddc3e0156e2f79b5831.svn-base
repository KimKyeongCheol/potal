...
<div class="login_area_loc">
	...
	<div class="loginbg02">
		...
		<ul>
           ...
           <li><a href="<c:url value='/uat/uia/egovLoginManager.do'/>">로그인</a></li>
        </ul>
        <% }else{ %>
        ...
        <ul>
            ...
            <li>|</li>
            <li><a href="<c:url value='/uat/uia/ManagerLogout.do'/>">로그아웃</a></li>
        </ul>
        <% } %>
	</div>
...
<script type="text/javascript">
    ...
    {
        document.selectOne.action = "<c:url value='/uat/uia/ManagerLogout.do'/>";
