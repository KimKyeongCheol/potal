...
public class EgovImageProcessController extends HttpServlet {
	 ...
	 */
	@SuppressWarnings("resource")
	@RequestMapping("/cmm/fms/getBanner_Image.do")
	public void getBannerImageInf(SessionVO sessionVO, ModelMap model, @RequestParam Map<String, Object> commandMap, HttpServletResponse response) throws Exception {
		...
		FileVO fvo = fileService.selectFileBannerInf(vo);
