...
package egovframework.let.uss.ion.msi.web;
...
public class EgovMainImageController {
    ...
    public String selectMainImageListView() throws Exception {
        ...
        return "/uss/ion/msi/EgovMainImageList";
    }
	...
	public String selectMainImage(@RequestParam("imageId") String imageId,
    	...
    	return "/uss/ion/msi/EgovMainImageUpdt";
	}
...
//			return "/uss/ion/msi/EgovMainImageUpdt";
			return "redirect:/uss/ion/msi/selectMainImageList.do";
...
//	    	return "forward:/uss/ion/msi/getMainImage.do";
	...
	public String selectMainImageResult(@ModelAttribute("mainImageVO") MainImageVO mainImageVO,
		...
		return "/uss/ion/msi/EgovMainImageView";
	}
	 ...
	 */
	@IncludedInfo(name="메인이미지 반영결과보기", order = 771 ,gid = 50)
	@RequestMapping(value="/uss/ion/msi/getSubImageResult.do")
	public String selectSubImageResult(@ModelAttribute("mainImageVO") MainImageVO mainImageVO,
		                                 ModelMap model) throws Exception {

		List<MainImageVO> fileList = egovMainImageService.selectSubImageResult(mainImageVO);
		model.addAttribute("fileList", fileList);
