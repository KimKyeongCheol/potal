		...
		<ul>
			<li>
				...
				<input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.do'/>" />
                  ...
                  <input type="text" name="fDate" size="10" title="<spring:message code="comStsBst.bbsStats.fromDate" />" id="fDate" value="${statsInfo.fromDate}"/> <!-- 시작일자 -->
                  <input type="text" name="tDate" size="10" tabindex="2" title="<spring:message code="comStsBst.bbsStats.toDate" />" id="tDate" value="${statsInfo.toDate}"/> <!-- 종료일자 -->
				...
				<select id="STKIND" name="STKIND" class="select" onchange="fnChangeStsKind();" tabindex="4" title="<spring:message code="comStsBst.bbsStats.statKind" />" >
				    ...
				    <option value='COM004'><spring:message code="comStsBst.bbsStats.statKind1" /></option> <!-- 게시판유형별 -->
