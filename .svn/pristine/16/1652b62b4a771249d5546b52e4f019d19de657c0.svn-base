...
public class EgovMberManageServiceImpl extends EgovAbstractServiceImpl implements EgovMberManageService {
	...
	public String insertMber(MberManageVO mberManageVO) throws Exception  {
		...
		mberManageDAO.insertGroup(mberManageVO);
		/*201911025 추가 회원가입시  권한부여*/
	 ...
	 */
	@Override
	public void deleteMber_user(String delId)  {

				mberManageDAO.deleteMber(delId);
	...
	/**
	 * 사용자의 정보를 데이터베이스에서 삭제
	 * @param MberManageVO 삭제대상 일반회원아이디
	 * @throws Exception
	 */
	@Override
	public void Withdrawal(MberManageVO mberManageVO) throws Exception  {
		

    	String enpassword = EgovFileScrty.encryptPassword(mberManageVO.getPassword(), mberManageVO.getMberId());
    	mberManageVO.setPassword(enpassword);

    
			mberManageDAO.Withdrawal(mberManageVO);
	...
	/* 2019.12.12 본인인증 추가 */
	@Override
	public void updateCert(MberManageVO mberManageVO) throws Exception {
		mberManageDAO.updateCert(mberManageVO);
	}
	/* 2019.12.12 본인인증 추가 */
	
	/* 2019.12.19 이메일 중복체크 추가 */
	/**
	 * 입력한 사용자아이디의 중복여부를 체크하여 사용가능여부를 확인
	 * @param checkEmail 중복여부 확인대상 아이디
	 * @return 사용가능여부(아이디 사용회수 int)
	 * @throws Exception
	 */
	@Override
	public int checkEmailDplct (String checkEmail) {
		return mberManageDAO.checkEmailDplct(checkEmail);
	}
	/* 2019.12.19 이메일 중복체크 추가 */
