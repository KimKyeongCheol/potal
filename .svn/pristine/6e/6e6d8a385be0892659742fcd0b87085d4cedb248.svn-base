...
package egovframework.let.uss.ion.msi.service.impl;

import java.util.List;

import egovframework.com.cmm.service.FileVO;
import egovframework.com.cmm.service.impl.EgovComAbstractDAO;
import egovframework.let.uss.ion.msi.service.MainImage;
...
public class MainImageDAO extends EgovComAbstractDAO {
	...
	public List<MainImageVO> selectMainImageList(MainImageVO mainImageVO) throws Exception {
		return (List<MainImageVO>) list("mainImageDAO.selectMainImageList", mainImageVO);
	}
    ...
    public int selectMainImageListTotCnt(MainImageVO mainImageVO) throws Exception {
        return (Integer)select("mainImageDAO.selectMainImageListTotCnt", mainImageVO);
    }
	...
	public MainImageVO selectMainImage(MainImageVO mainImageVO) throws Exception {
		return (MainImageVO) select("mainImageDAO.selectMainImage", mainImageVO);
	}
	...
	public FileVO selectMainImageFile(MainImage mainImage) throws Exception {
		return (FileVO) select("mainImageDAO.selectMainImageFile", mainImage);
	}
	...
	public List<MainImageVO> selectMainImageResult(MainImageVO mainImageVO) throws Exception {
		return (List<MainImageVO>) list("mainImageDAO.selectMainImageResult", mainImageVO);
	}
	/**
	 * 메인화면이미지가 특정화면에 반영된 결과를 조회한다.
	 * @param mainImageVO - 메인이미지 VO
	 * @return MainImageVO - 메인이미지 VO
	 */
	public List<MainImageVO> selectSubImageResult(MainImageVO mainImageVO) throws Exception {
		return (List<MainImageVO>) list("mainImageDAO.selectSubImageResult", mainImageVO);
	}
