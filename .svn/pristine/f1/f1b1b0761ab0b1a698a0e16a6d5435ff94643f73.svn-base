					...
					<div class="board-list-box">
							...
							<div class="gallery-list-box">
								<ul>
									...
									<li>
									<div class="img-view">
									 <c:import url="/cmm/fms/selectImageFile.do" charEncoding="utf-8">
				                        <c:param name="atchFileId" value="${result.atchFileId}" />
				                    </c:import>
												<!-- <img src="../common/images/img-thum-01.jpg"> -->
									</div>
									<div class="txt-box">
											...
											<a href="" class="ellipsis tit">
											<%-- <a class="ellipsis" href="#" onclick="view_bbs(this)"><c:out value="${result.nttSj}"/></a> --%>
											<a class="ellipsis" href="<c:url value='/cop/bbs${prefix}/selectBoardArticle.do?us=usr'/>&bbsId=<c:out value='${result.bbsId}'/>&nttId=<c:out value='${result.nttId}'/>" /><c:out value="${result.nttSj}"/></a>
											
											<div class="date-box"><c:out value="${result.frstRegisterPnttm}" /></div>
													</c:otherwise>
												</c:choose>
											</form>
