    ...
    <div id="bodywrap">
		...
		<!-- class : path-wrap : (E) -->
           <!--contents start-->
	        ...
	        <form name="Withdrawal" method="post" action="<c:url value="/Withdrawal.do"/>" >
            ...
            <div class="search_service body-box myinfo">
                <div class="search_top_table base-inner">
							...
							<c:if test="${result.upperMenuId eq 0 }">
									...
									<c:if test="${result.menuNo eq 1200000}">
										...
										<c:if test="${sub_result.upperMenuId eq result.menuNo}">
											...
											<c:if test="${sub_result.menuNo eq 1203000}">
												<li class="menu_on">
											</c:if>
											<c:if test="${sub_result.menuNo ne 1203000}">
												<li class="">
											</c:if>
                    ...
                    <table summary="SUMMARY">
                        <tr>
			                <td class="td_width"><label for="mberId">회원아이디</label>
			            ...
			            <tr> 
			                <td class="td_width"><label for="Password">비밀번호</label>
			                    <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/>
			                </td>
			                <td class="td_content">
            ...
            <div class="buttons" align="center" style="margin-bottom:100px">
               ...
               <a href="#" onclick="user_delete(); return false;" >탈퇴</a>
                <!-- 취소 -->
