...
public class BoardUseInfVO extends BoardUseInf implements Serializable {
    ...
    public String getProvdUrl_User() {
		return provdUrl_User;
	}

	public void setProvdUrl_User(String provdUrl_User) {
		this.provdUrl_User = provdUrl_User;
	}

	/** 제공 (사용자용) URL */
    private String provdUrl_User = "";
