...
function actionLogin() {
    ...
    if (document.loginForm.id.value =="") {
        ...
        document.loginForm.action="<c:url value='/uat/uia/AdminSecurityLogin.do'/>";
...
<div id="wrap"> 
    ...
    <c:import url="/sym/mms/EgovMainMenuHeadAdmin.do?flag=MAIN" /></div>
    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
            ...
            <div class="search_service">
                ...
                <form name="loginForm" action ="<c:url value='/uat/uia/AdminSecurityLogin.do'/>" method="post"> 
