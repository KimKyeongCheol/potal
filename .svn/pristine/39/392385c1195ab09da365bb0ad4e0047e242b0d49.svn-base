...
System.out.println("loginVO_chk ==============" +loginVO_chk);
if(loginVO_chk == null){
	
	%>
	<<script type="text/javascript">
	<!--
/* location.href="<c:url value='/AdminPage.do'/>"; */
	//-->
	</script>
	<%
/*  response.sendRedirect("/AdminPage.do"); */

System.out.println("null" +loginVO_chk); 
}
%>
...
<div class="login_area_loc">
	...
	<div class="loginbg02">
        ...
        <ul>
           ...
           <li><a href="<c:url value='/egovLoginAdmin.do'/>">로그인</a></li>
        </ul>
        <% }else{ %>
        ...
        <ul>
            ...
            <li>|</li>
            <li><a href="<c:url value='/uat/uia/AdminLogout.do'/>">로그아웃</a></li>
        </ul>
        <% } %>
    </div>
		<div class="loginbg03"></div>
</div>
<h1><a href="<c:url value='/'/>AdminPage.do">템플릿 로고</a>
...
<ul>
	<c:forEach var="result" items="${list_headmenu}" varStatus="status">
	            <c:if test="${result.menuNo eq 5000000 || result.menuNo eq 6000000}">
