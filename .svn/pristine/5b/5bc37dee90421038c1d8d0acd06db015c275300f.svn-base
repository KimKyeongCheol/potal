...
public class EgovAuthorManageController {
	...
	public String selectAuthorList(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO, ModelMap model, HttpSession session, HttpServletResponse response) throws Exception {
