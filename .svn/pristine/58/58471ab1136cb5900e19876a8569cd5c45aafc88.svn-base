...
<div id="wrap">
	<!-- header start -->
	<header id="header"><c:import url="/sym/mms/EgovMainMenuHead.do?flag=MAIN" /></header>
			...
			<div class="base-inner">
				...
				<div class="grally-box">
					...
					<div class="avi-box">
						...
						<video id="vid" src="<c:url value='/video/promotional_video.mp4'/>" width="100%" height="100%" autoplay="autoplay" controls="controls" muted="muted">
						</video>
