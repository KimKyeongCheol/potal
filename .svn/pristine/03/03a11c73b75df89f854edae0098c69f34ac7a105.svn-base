...
import egovframework.let.sym.mnu.mcm.service.MenuSiteMapVO;
...
public class MenuCreateManageDAO extends EgovComAbstractDAO{
	...
	public int selectUsrByPk(ComDefaultVO vo) throws Exception{
		return (Integer)select("menuManageDAO.selectUsrByPk", vo);
	}
	...
	public MenuCreatVO selectAuthorByUsr(ComDefaultVO vo) throws Exception{
		return (MenuCreatVO)select("menuManageDAO.selectAuthorByUsr", vo);
	}
    ...
    public int selectMenuCreatManagTotCnt(ComDefaultVO vo) {
        return (Integer)select("menuManageDAO.selectMenuCreatManageTotCnt_S", vo);
    }
    ...
    public int selectMenuCreatCnt(MenuCreatVO vo) {
        return (Integer)select("menuManageDAO.selectMenuCreatCnt_S", vo);
    }
    ...
    public int selectSiteMapCnt(MenuSiteMapVO vo) {
        return (Integer)select("menuManageDAO.selectSiteMapCnt_S", vo);
    }
