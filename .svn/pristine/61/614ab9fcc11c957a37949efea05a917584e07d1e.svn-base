...
public interface EgovMenuManageService {
	...
	/**
	 * 사용자 메인페이지  MainMenu Head Menu 조회 - Anonymous
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	List<?> selectMainMenuHeadByUser(MenuManageVO vo) throws Exception;

	/**
	 * 사용자 메인페이지  SubMenu Head Menu 조회 - Anonymous
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	List<?> selectSubMenuHeadByUser(MenuManageVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	List<?> selectMainSubMenuHeadByUser(MenuManageVO vo) throws Exception;
	...
	List<?> selectContentRoot() throws Exception;
	/* 2019.11.11 콘텐츠페이지 수정 */
