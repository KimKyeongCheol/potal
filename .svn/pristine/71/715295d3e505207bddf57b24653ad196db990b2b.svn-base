...
/* 	if(validateMberManageVO(document.mberManageVO)){
        ...
        var pass = document.mberManageVO.password.value;
        var zip =document.mberManageVO.zip_view.value;
        
        if(document.mberManageVO.mberId.value == "" || document.mberManageVO.mberId.value == null){
        	alert("아이디를 입력해 주세요");
			return;
        }        
        if(document.mberManageVO.password.value == "" || document.mberManageVO.password.value == null){
        	alert("비밀번호을 입력해 주세요");
			return;
        }
        if(document.mberManageVO.password2.value == "" || document.mberManageVO.password2.value == null){
        	alert("비밀번호을 입력해 주세요");
        return;
		}
   ...
   if(checkPassword(pass) == true){
        ...
        if(document.mberManageVO.passwordHint.value == "" || document.mberManageVO.passwordHint.value == null){
        	alert("비밀번호힌트를  입력해 주세요");
			return;
        }
        if(document.mberManageVO.passwordCnsr.value == "" || document.mberManageVO.passwordCnsr.value == null){
        	alert("비밀번호정답을 입력해 주세요");
        return;
		}
        if(document.mberManageVO.mberNm.value == "" || document.mberManageVO.mberNm.value == null){
        	alert("성명을입력해 주세요");
			return;
        }
        if(document.mberManageVO.areaNo.value == "" || document.mberManageVO.areaNo.value == null && document.mberManageVO.middleTelno.value == "" || document.mberManageVO.middleTelno.value == null && document.mberManageVO.endTelno.value == "" || document.mberManageVO.endTelno.value == null){
        	alert("전화 번호를 입력해 주세요");
			return;
        }
      if(document.mberManageVO.password.value != document.mberManageVO.password2.value){
            alert("비밀번호화 비밀번호확인이 같아야 합니다.");
            return;
        }
      

    	  document.mberManageVO.zip.value = zip;
            ...
            <div class="search_service">
                <div class="search_top_table">
                    <table summary="일반회원 가입정보">
			            <tr> 
			                <td class="td_width" rowspan="2">아이디
			            ...
			            <tr>
			                <td>
			                <a>영문(소문자)또는 영문(소문자)와 숫자 조합하여 5~15 자 이내로 입력하세요</a>
			                </td>
			            </tr>
			            <tr> 
			                <td class="td_width" rowspan="2">비밀번호
			                    <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/>
			                </td>
			                <td class="td_content">
			            ...
			            <tr>
			                <td>
			                <a>영문(대/소문자)과 숫자, 특수문자 조합하여 8자 이상 입력하세요.
(단 ~!@#$%^&*()_+|<>?:{} 만 사용가능)</a>
			                </td>
			            </tr>
			            <tr> 
			            ...
			            <tr> 
			                <td class="td_width" rowspan="3">주소
			                </td>
			                <td class="td_content">
			            ...
			            <tr> 
			                ...
			                <td class="td_content">
			                <input name="University_name" type="text" class="txaIpt">
			                </td>
			            </tr>
