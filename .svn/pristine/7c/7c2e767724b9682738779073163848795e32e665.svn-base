...
public class MenuManageDAO extends EgovAbstractDAO{
	...
	/**
	 * 사용자페이지  MainMenu Head Menu 조회 - Anonymous
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	public List<?> selectMainMenuHeadByUser(MenuManageVO vo) throws Exception{
		return list("menuManageDAO.selectMainMenuHeadByUser", vo);
	}

	
	/**
	 * 사용자페이지  SubMenu Head Menu 조회 - Anonymous
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	public List<?> selectSubMenuHeadByUser(MenuManageVO vo) throws Exception{
		return list("menuManageDAO.selectSubMenuHeadByUser", vo);
	}
	 ...
	 * @exception Exception
	 */
	public List<?> selectMainSubMenuHeadByUser(MenuManageVO vo) throws Exception{
		return list("menuManageDAO.selectMainSubMenuHeadByUser", vo);
	}
	...
	public List<?> selectContentRoot() throws Exception{
		return list("menuManageDAO.selectContentRoot");
	}
	/* 2019.11.11 콘텐츠페이지 수정 */
