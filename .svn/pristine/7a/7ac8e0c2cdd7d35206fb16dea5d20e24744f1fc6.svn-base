<%--
  Class Name : EgovServiceResult.jsp
  Description : 샘플화면 - 민원신청결과확인화면(sample)
...
<div id="wrap">	
	<!-- header start -->
	<div id="subheader"><c:import url="/sym/mms/EgovMainMenuHead_Admin.do" /></div>	
	<!-- //header end -->
	<!--  타이틀 이미지 시작 -->
	...
	<div id="bodywrap">
		...
		<div id="middle_content">
			...
			<div id="content_field">
				<div><h2>민원신청결과확인</h2></div>
				<p>※7일 이전의 신청내용은 검색기간을 입력한 후 확인하시기 바랍니다.</p>
				<div class="search_service">
					<div class="search_area">					
						<form action="" name="SubTopSearch2" id="SubTopSearch2" method="post">
