...
<script>
	var temp = "<%=request.getServletContext().getContextPath()%>";
	var temp1 = temp + "/MberUpdtView.do";
	var temp2 = temp + "/updateCert.do";
	var msg = "<%=sMessage%>";
	var iReturn = "<%=iReturn%>";
	if(iReturn == 0){
		alert("정상처리되었습니다.");
		self.close();
		opener.location.href = temp2;
	}else{
		alert(msg);
		self.close();
		opener.location.href = temp1;
	}
</script>
<body>
    <center>
