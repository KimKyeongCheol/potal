            ...
            <div class="search_service">
                <div class="search_top_table">
                    <table summary="게시판명, 커뮤니티/ 동호회명, 사용여부  입니다" >
				      ...
				      <tr> 
				        <td class="td_width">제공 URL(관리자용)</td>
				        <td class="td_content">
				      ...
				      <c:if test="${not empty bdUseVO.provdUrl_User}">
				      		      <tr> 
				        <td class="td_width">제공 URL(사용자용)</td>
				        <td class="td_content">
				            <a href="<c:url value="${bdUseVO.provdUrl_User}" />" target="_new">
				                <c:url value="${bdUseVO.provdUrl_User}" />
				            </a>
				        </td>
				      </tr>
				      </c:if>
