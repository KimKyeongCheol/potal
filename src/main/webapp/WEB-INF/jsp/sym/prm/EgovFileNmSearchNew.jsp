...
function choisProgramListSearch(vFileNm) {
	...
	//var parentFrom = parent.document.getElementsByTagName('menuManageVO');
	//alert(parentFrom.action);
	//parentFrom[0].progrmFileNm.value = progrmFileNm;
    //parent.$('.ui-dialog-content').dialog('close');
    
/*  	var fileNm = opener.document.getElementById("progrmFileNm").value;

	 	if(fileNm != ""){
		opener.document.getElementById("progrmFileNm").value="";
	} */
     opener.document.getElementById("progrmFileNm").value = progrmFileNm;
    self.opener = self; 
/* 	window.close(); */
...
<div class="board" style="width:480px">
	<h1><spring:message code="comSymPrm.fileNmSearch.pageTop.title"/></h1><!-- 프로그램파일명 검색111 -->
