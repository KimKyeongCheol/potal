	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<input type="text" name="searchBeginDate" id="searchBeginDate" size="15" maxlength="10" value="${searchVO.searchBeginDate}" title="<spring:message code="comSymLogPlg.seachWrd.searchBeginDate" />" ><!-- <img class="ui-datepicker-trigger" src="/pst_webapp/images/calendar.gif" alt="..." title="..."> --> ~ <!-- 검색시작일  -->
