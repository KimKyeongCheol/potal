...
<div id="wrap"> 
 ...
 <div id="content_field"><!--contents start-->
            ...
            <!-- sub title start -->
            <div><h2>공통코드상세</h2></div>
            <!-- sub title end -->

<form:form commandName="cmmnDetailCodeVO" action="${pageContext.request.contextPath}/sym/ccm/cde/RegistCcmCmmnDetailCode.do" method="post" onSubmit="fn_egov_regist_code(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
