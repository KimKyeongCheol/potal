	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<input class="s_input2 vat" name="authorCode" type="text" value="${resultVO.authorCode}" size="20" maxlength="30" title="<spring:message code="comSymMnuMpm.MenuCreatSiteMap.authName" />" readonly="readonly" /><!-- 권한명 -->
				<input class="s_input2 vat" name="chkCreat" type="text" value="${resultBoolean.chkCreat}" size="10" maxlength="10" title="<spring:message code="comSymMnuMpm.MenuCreatSiteMap.authCode" />" readonly="readonly" /><!-- 권한코드 -->
