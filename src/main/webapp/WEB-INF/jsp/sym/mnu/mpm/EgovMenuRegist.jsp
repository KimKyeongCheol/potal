	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left" colspan="3">
			    <form:input path="progrmFileNm" id="progrmFileNm" maxlength="60" onkeypress="press();" title="파일명" readonly="true" class="readOnlyClass" cssStyle="width:350px" /><!-- 파일명 -->
			    <form:errors path="progrmFileNm" />
		        <a id="popupProgrmFileNm"  title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>">
