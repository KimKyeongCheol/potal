...
<div id="wrap"> 
    ...
    <div id="bodywrap">
		...
		<!-- class : path-wrap : (E) -->
	        ...
	        <form name="passwordChgVO" method="post" action="<c:url value="/new_Password.do"/>" >
                ...
                <div class="search_top_table base-inner"> 
                    ...
                    <table summary="SUMMARY">
                        <tr>
			                ...
			                <td class="td_content">
			                    <input name="mberId" id="mberId" type="text" size="20" value="<c:out value='${mberManageVO.id}'/>"  maxlength="20" readonly />
		...
		<%-- 		                    <input name="userTy" id="userTy" type="hidden" size="20" value="<c:out value='${mberManageVO.userTy}'/>" /> --%>
			            ...
			            <tr> 
			                <td class="td_width"><label for="newPassword">새로운 비밀번호</label>
			                    <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/>
			                </td>
			                <td class="td_content"><input name="newPassword" id="newPassword" type="password" size="20" value=""  maxlength="100" /></td>
			            </tr>
			            <tr>
			                <td class="td_width"><label for="newPassword2">새로운 비밀번호 확인</label>
			                    <img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" width="15" height="15"/>
			                </td>
