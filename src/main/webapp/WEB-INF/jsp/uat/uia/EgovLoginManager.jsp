...
function actionLogin() {
    ...
    if (document.loginForm.id.value =="") {
        ...
        document.loginForm.action="<c:url value='/uat/uia/ManagerSecurityLogin.do'/>";
...
<div id="wrap"> 
    <!-- header start -->
    <div id="header"><c:import url="/sym/mms/EgovMainMenuHeadManager.do?flag=MAIN" /></div>
    ...
    <div id="bodywrap">
        ...
        <div id="middle_content">
            ...
            <div class="search_service">
                ...
                <form name="loginForm" action ="<c:url value='/uat/uia/ManagerSecurityLogin.do'/>" method="post"> 
