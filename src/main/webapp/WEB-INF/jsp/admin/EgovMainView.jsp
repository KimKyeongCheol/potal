...
<div id="wrap">
	<!-- header start -->
	<div id="header"><c:import url="/sym/mms/EgovMainMenuHeadAdmin.do?flag=MAIN" /></div>
	<!-- //header end -->
	<!-- 타이틀이미지, 로그인 시작 -->
	<div id="titlewrap">
	<a>관리자 메인 페이지</a>
		...
		<div class="main_login">
			...
			<ul class="btn_area">
				...
				<li><a href="<c:url value='/egovLoginAdmin.do'/>"><img alt="로그인" src="<c:url value='/'/>images/header/btn_login.gif" /></a></li>
			</ul>
