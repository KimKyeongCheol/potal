	...
	<div class="base-inner">
		...
		<div class="hd-search-box">
			...
			<!-- <form action="#LINK" name="TopSearchForm" method="post">
					<fieldset>
							<input type="text" title="검색단어" class="input" name="search"	id="search">
							<a href="" class="ico-search">검색버튼</a>
					</fieldset>
				</form> -->
			<script>
			function Search(){
		...
		<div class="hd-util-box">
			<ul>
				...
				<li class="on"><a href="<c:url value='/uat/uia/egovLoginUsr.do'/>">로그인</a></li>
...
<li>
<%--  <a href="<c:url value='/MberUpdtView.do'/>">마이페이지</a> --%>
