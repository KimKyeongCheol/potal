...
<c:out value="${brdMstrVO.bbsTyCode}"/>
			<!-- class : body-box : (S) -->
			<div class="body-box">
...
<tbody>
						...
						<div class="board-btm-box">
							...
							<div class="search-box">
								...
								<form name="frm" action="/pst_webapp/cop/bbs/selectBoardList.do" method="post">
									...
									<input name="pageIndex" type="hidden" value="1">
										...
										</select> <input class="input" name="searchWrd" type="text" value="" onkeypress="press(event);" title="검색어 입력">
	


									<a class="btn" href="/pst_webapp/cop/bbs/addBoardArticle.do?bbsId=BBSMSTR_AAAAAAAAAAAA">검색</a>
