...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_regist_qnacn(form) {
		...
		if (!validateQnaManageVO(form)) {
			...
			form.action = "<c:url value='/QnaRegist.do'/>";
			form.submit();
		}
	}
			...
			<div id="middle_content">
				...
				<div id="content_field">
					...
					<form:form commandName="qnaManageVO" name="qnaManageVO"
						action="${pageContext.request.contextPath}/QnaRegist.do"
						method="post">
								...
								<table summary="Q&amp;A에 대한 정보를 등록합니다.">
									...
									<tr>
										<td class="td_width"><label for="writngPassword">작성
											...
											alt="필수항목" title="필수항목" width="15" height="15" /></td>
										<td class="td_content"><form:password
												path="writngPassword" size="20" maxlength="20"
												title="작성 비밀번호" /> <form:errors path="writngPassword" /></td>
									</tr>
									...
									<tr>
										...
										<td class="td_content"><textarea id="qestnCn"
												...
												title="질문내용"></textarea> <form:errors path="qestnCn" /></td>
									</tr>
							...
							<tr>
								<td>
									<div class="buttons" align="center"
										...
										<a href="#"
											onclick="fn_egov_regist_qnacn(document.qnaManageVO); return false;"><spring:message
												code="button.save" /></a> <a
