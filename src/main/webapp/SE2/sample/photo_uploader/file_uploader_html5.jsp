...
<%
	...
	// 파일 기본경로 _ 상세경로
	String path = defaultPath + "/uploadImg" + File.separator;
	...
	//System.out.println("file : " + path + realname);
...
// 	}
	...
	sFileInfo += "&bNewLine=true&sFileName="+ name+"&sFileURL="+"/uploadImg/"+realname;
