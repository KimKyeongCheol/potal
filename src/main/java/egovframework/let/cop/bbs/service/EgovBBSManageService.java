...
public interface EgovBBSManageService {
	 ...
	 * @exception Exception Exception
	 */
	public BoardVO selectBoardAll(BoardVO boardVO)
	  throws Exception;
	 ...
	 * @exception Exception Exception
	 */
	public Map<String, Object> selectBoardAlls(BoardVO boardVO)
	  throws Exception;
	
	public Map<String, Object> selectBoardSearchAll(BoardVO boardVO)
			  throws Exception;
