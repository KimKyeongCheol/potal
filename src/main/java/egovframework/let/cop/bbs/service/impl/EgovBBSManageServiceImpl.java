...
String fi =	board.getAtchFileId();
	...
	if(fi != null){
		...
		fvo.setAtchFileId(fi);
		
	FileVO fvoNm =  fileService.selectFileNm(fvo);
	fvo.setFileSn(fvoNm.getFileSn());

    String fileNm = fvoNm.getStreFileNm();
	if (!"".equals(fvo.getAtchFileId()) || fvo.getAtchFileId() != null) {
		String storePathString = propertyService.getString("Globals.fileStorePath");

        String filePath = storePathString+"/"+fileNm;
	...
	return bbsMngDAO.selectBoardAll(boardVO);
    }
     ...
     * @see egovframework.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
    public Map<String, Object> selectBoardAlls(BoardVO boardVO) throws Exception {
	List<BoardVO> list = bbsMngDAO.selectBoardAllList(boardVO);
	List<BoardVO> result = new ArrayList<BoardVO>();
	...
	int cnt = bbsMngDAO.selectBoardAllListCnt(boardVO);
     ...
     * @see egovframework.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(egovframework.let.cop.bbs.brd.service.BoardVO)
     */
    public Map<String, Object> selectBoardSearchAll(BoardVO boardVO) throws Exception {
	List<BoardVO> list = bbsMngDAO.selectBoardSearchAllList(boardVO);
	List<BoardVO> result = new ArrayList<BoardVO>();



	int cnt = bbsMngDAO.selectBoardSearchAllListCnt(boardVO);
