...
public class BBSManageDAO extends EgovAbstractDAO {
    ...
    /**
     * 전체게시물 한 건에 대하여 상세 내용을 조회 한다.
     *
     * @param boardVO
     * @return
     * @throws Exception
     */
    public BoardVO selectBoardAll(BoardVO boardVO) throws Exception {
	return (BoardVO)select("BBSManageDAO.selectBoardArticle", boardVO);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardAllList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectBoardAllList", boardVO);
    }

    /**
     * 전체게시물 목록에 대한 전체 건수를 조회 한다.
     *
     * @param boardVO
     * @return
     * @throws Exception
     */
    public int selectBoardAllListCnt(BoardVO boardVO) throws Exception {
	return (Integer)select("BBSManageDAO.selectBoardAllListCnt", boardVO);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardSearchAllList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectBoardSearchAllList", boardVO);
    }
    
    /**
     * 통합검색 조건에 맞는 게시물 목록에 대한 전체 건수를 조회 한다.
     *
     * @param boardVO
     * @return
     * @throws Exception
     */
    public int selectBoardSearchAllListCnt(BoardVO boardVO) throws Exception {
	return (Integer)select("BBSManageDAO.selectBoardSearchAllListCnt", boardVO);
    }
