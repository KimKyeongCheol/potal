...
public class EgovBBSManageController {
	 ...
	 * @throws Exception
	 */
/* 20191112 추가 관리자, 사용자페이지 이동 나누기	@RequestParam(value="view", required=false) String view */
	@RequestMapping("/cop/bbs/selectBoardList.do")
	public String selectBoardArticles(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request,HttpSession session, HttpServletResponse response) throws Exception {
	...
	public String selectBoardArticle(@RequestParam(value="us", required=false) String us ,@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		if(us== null) {
				us= "admin";
		}
		...
		if(loginVO != null) {
			if(loginVO.getCode().equals("ROLE_ADMIN")) {
				if(us.equals("usr")) {
					return "usr/bbs/"+dir+"/View";	
				}else {
					return "cop/bbs/View";	
				}
				
			}else if(loginVO.getCode().equals("ROLE_BBS_MANAGER")) {
			...
			}else if(loginVO.getCode().equals("ROLE_ANONYMOUS")) {
...
/*		return "cop/bbs/EgovNoticeRegist";*/
	...
	public String insertBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
			@ModelAttribute("board") Board board, BindingResult bindingResult, SessionStatus status, ModelMap model, HttpServletRequest request) throws Exception {
	...
	public String selectBoardArticleForUpdt(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model, HttpServletRequest request) throws Exception {
	...
	/**
	 * 템플릿에 대한 미리보기용 게시물 목록을 조회한다.(관리자페이지)
	 *
	 * @param boardVO
	 * @param sessionVO
	 * @param model
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/bbs/selectBoardAllList.do")
	public String selectBoardAlls(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		// 메인화면에서 넘어온 경우 메뉴 갱신을 위해 추가
		...
		Map<String, Object> map = bbsMngService.selectBoardAlls(boardVO);
		int totCnt = Integer.parseInt((String) map.get("resultCnt"));
...
if(loginVO != null) {
			...
			if(loginVO.getCode().equals("ROLE_ADMIN")) {
				return "cop/bbs/EgovAllList";
			}else if(loginVO.getCode().equals("ROLE_BBS_MANAGER")) {
				return "cop/bbs/EgovAllList";
			}else if(loginVO.getCode().equals("ROLE_ANONYMOUS")) {
				return "usr/bbs/AllList";
			}else if(loginVO.getCode().equals("ROLE_USER_MEMBER")) {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/bbs/selectBoardAll.do")
	public String selectBoardAll(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		LoginVO user = new LoginVO();
		if (EgovUserDetailsHelper.isAuthenticated()) {
			user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		}
		...
		boardVO.setLastUpdusrId(user.getUniqId());
		BoardVO vo = bbsMngService.selectBoardAll(boardVO);
		...
		if(loginVO != null) {
			...
			if(loginVO.getCode().equals("ROLE_ADMIN")) {
				return "cop/bbs/EgovAllInqire";
			}else if(loginVO.getCode().equals("ROLE_BBS_MANAGER")) {
				return "cop/bbs/EgovAllInqire";
			}else if(loginVO.getCode().equals("ROLE_ANONYMOUS")) {
				return "usr/bbs/AllView";
			}else if(loginVO.getCode().equals("ROLE_USER_MEMBER")) {
	...
	/*사용자 페이지 게시물 등록처리 20191114 추가*/
	/**
	 * 사용자 페이지 게시물에 대한 목록을 조회한다.
	 *
	 * @param boardVO
	 * @param sessionVO
	 * @param model
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/selectBoardList_user.do")
	public String selectBoardArticles_user(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		// 메인화면에서 넘어온 경우 메뉴 갱신을 위해 추가
	...
	return "usr/bbs/"+dir+"/List";


			}
	
	/**
	 * 사용자페이지 게시물 등록을 위한 등록페이지로 이동한다.
	 *
	 * @param boardVO
	 * @param sessionVO
	 * @param model
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/addBoardArticle_user.do")
	public String addBoardArticle_user(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
...
/*		return "cop/bbs/EgovNoticeRegist";*/
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/insertBoardArticle_user.do")
	public String insertBoardArticle_user(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
			@ModelAttribute("board") Board board, BindingResult bindingResult, SessionStatus status, ModelMap model, HttpServletRequest request) throws Exception {

		LoginVO user = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		String dir =board.getBbsId();
...
/*		return "usr/bbs/"+dir+"/List";*/
		return "redirect:selectBoardList_user.do?bbsId="+dir;
		
		
/*		return "forward:/cop/bbs/selectBoardList.do?us=usr";*/
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/forUpdateBoardArticle_user.do")
	public String selectBoardArticleForUpdt_user(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model, HttpServletRequest request) throws Exception {
		...
		String dir =bmvo.getBbsId();

		
		

		return "usr/bbs/"+dir+"/Updt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/updateBoardArticle_user.do")
	public String updateBoardArticle_user(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
			@ModelAttribute("board") Board board, BindingResult bindingResult, ModelMap model, SessionStatus status) throws Exception {
...
/*		return "forward:/cop/bbs/selectBoardList.do?us=usr";*/
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/addReplyBoardArticle_user.do")
	public String addReplyBoardArticle_user(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
			model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
			return "uat/uia/EgovLoginUsr";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/replyBoardArticle_user.do")
	public String replyBoardArticle_user(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("bdMstr") BoardMaster bdMstr,
			@ModelAttribute("board") Board board, BindingResult bindingResult, ModelMap model, SessionStatus status) throws Exception {
...
/*		return "forward:/cop/bbs/selectBoardList.do?us=usr";*/
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/deleteBoard_user.do")
	public String deleteBoardArticle_user(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board, @ModelAttribute("bdMstr") BoardMaster bdMstr, ModelMap model)
			throws Exception {
...
/*		return "forward:/cop/bbs/selectBoardList.do";*/
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/selectBoardArticle_user.do")
	public String selectBoardArticle_user(@RequestParam(value="us", required=false) String us ,@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		if(us== null) {
				us= "admin";
		}
	...
	public String selectBoarSearch_user(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, HttpServletRequest request) throws Exception {
		// 메인화면에서 넘어온 경우 메뉴 갱신을 위해 추가
		...
		Map<String, Object> map = bbsMngService.selectBoardSearchAll(boardVO);
		int totCnt = Integer.parseInt((String) map.get("resultCnt"));
