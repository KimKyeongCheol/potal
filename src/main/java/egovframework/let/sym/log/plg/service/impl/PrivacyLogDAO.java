package egovframework.let.sym.log.plg.service.impl;

import java.util.List;

import egovframework.com.cmm.service.impl.EgovComAbstractDAO;
import egovframework.let.sym.log.plg.service.PrivacyLog;
...
public class PrivacyLogDAO extends EgovComAbstractDAO {
	...
	public int selectPrivacyLogListCount(PrivacyLog privacyLog) throws Exception{
		return (Integer)select("PrivacyLog.selectPrivacyLogListCount", privacyLog);
	}
	...
	public PrivacyLog selectPrivacyLog(PrivacyLog privacyLog) throws Exception{
		return (PrivacyLog) select("PrivacyLog.selectPrivacyLog", privacyLog);
	}
