...
public class EgovMenuManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuManageService{
	...
	public List<?> selectMainMenuHeadByUser(MenuManageVO vo) throws Exception {
   		return menuManageDAO.selectMainMenuHeadByUser(vo);
	}
	/**
	 * 사용자 페이지 SubMenu Head Menu 조회
	 * @param vo MenuManageVO
	 * @return List
	 * @exception Exception
	 */
	...
	public List<?> selectSubMenuHeadByUser(MenuManageVO vo) throws Exception {
   		return menuManageDAO.selectSubMenuHeadByUser(vo);
	}
	/**
	 * 사용자 페이지 SubMenu Head Menu 조회
	 * @param vo MenuManageVO
	...
	public List<?> selectMainSubMenuHeadByUser(MenuManageVO vo) throws Exception {
   		return menuManageDAO.selectMainSubMenuHeadByUser(vo);
	}
	...
	public List<?> selectContentRoot() throws Exception {
   		return menuManageDAO.selectContentRoot();
	}
	/* 2019.11.11 콘텐츠페이지 수정 */
