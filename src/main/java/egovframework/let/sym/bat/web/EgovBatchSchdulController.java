...
import egovframework.let.sym.bat.service.BatchSchdul;
import egovframework.let.sym.bat.service.BatchScheduler;
import egovframework.let.sym.bat.service.EgovBatchSchdulService;
...
public class EgovBatchSchdulController {
	...
	public String insertBatchSchdul(BatchSchdul batchSchdul, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			//아이디 설정
			batchSchdul.setLastUpdusrId(loginVO.getUniqId());
			batchSchdul.setFrstRegisterId(loginVO.getUniqId());
