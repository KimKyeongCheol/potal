package egovframework.let.sym.bat.web;
...
import egovframework.let.sym.bat.service.BatchOpert;
import egovframework.let.sym.bat.service.EgovBatchOpertService;
import egovframework.let.sym.bat.validation.BatchOpertValidator;
...
public class EgovBatchOpertController {
	...
	public String insertBatchOpert(BatchOpert batchOpert, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			...
			//아이디 설정
			batchOpert.setLastUpdusrId(loginVO.getUniqId());
			batchOpert.setFrstRegisterId(loginVO.getUniqId());
