...
public class MberManageDAO extends EgovAbstractDAO{
    ...
    /** 
     * 일반회원의 기본권한을 데이터베이스에 저장
     * @param mberManageVO 일반회원 등록정보
     * @return String 등록결과
     */
    public String insertGroup(MberManageVO mberManageVO){
        return (String)insert("mberManageDAO.insertAuthorGroup", mberManageVO);
    }
    /*201911025 추가 회원가입시  권한부여*/
    ...
    public int checkIdDplct(String checkId){
        return (Integer)select("mberManageDAO.checkIdDplct_S", checkId);
    }
    
	/*20191210 회원 탈퇴 처리 추가*/
    /**
     * 회원의 정보를 데이터베이스에서 삭제
     * @param mberManageVO 삭제 대상 일반회원아이디
     */
    public void Withdrawal(MberManageVO mberManageVO){
    	
    	update("mberManageDAO.Withdrawal_D", mberManageVO);
    }
	/*20191210 회원 탈퇴 처리 추가*/
    
    /* 2019.12.12 본인인증 추가 */
    public void updateCert(MberManageVO mberManageVO){
        update("mberManageDAO.updateCert",mberManageVO);
    }
    /* 2019.12.12 본인인증 추가 */
    ...
    /*20191219 이메일 중복체크 추가*/
    public int checkEmailDplct(String checkEmail){
        return (Integer)select("mberManageDAO.checkEmailDplct_S", checkEmail);
    }
