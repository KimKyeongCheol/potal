...
private EgovLoginService loginService;
    ...
    public String selectFaqList(@ModelAttribute("searchVO") FaqManageDefaultVO searchVO, ModelMap model, HttpServletRequest request, HttpSession session
) throws Exception {
...
if(loginVO != null) {
			if(loginVO.getCode().equals("ROLE_ADMIN")) {
				...
				return "/usr/olh/faq/EgovFaqListInqire";
		 ...
		 HttpSession session=request.getSession();
			...
			if(loginVO != null) {
				...
				if(loginVO.getCode().equals("ROLE_ADMIN")) {
					...
					return "/usr/olh/faq/EgovFaqDetailInqire";
				}else if(loginVO.getCode().equals("ROLE_USER_MEMBER")) {
  ...
  /*      return	"/uss/olh/faq/EgovFaqDetailInqire";*/
		 ...
		 HttpSession session=request.getSession();
			...
			if(loginVO != null) {
				...
				if(loginVO.getCode().equals("ROLE_ADMIN")) {
					...
					return "/usr/olh/faq/EgovFaqCnUpdt";
				}else if(loginVO.getCode().equals("ROLE_USER_MEMBER")) {
    ...
    public String updateFaqCn(@RequestParam("atchFileAt") String atchFileAt ,
    	...
    	beanValidator.validate(faqManageVO, bindingResult);
    	 ...
    	 HttpSession session=request.getSession();
    	 LoginVO loginVO_chk=(LoginVO)session.getAttribute("LoginVO");
		...
		if(bindingResult.hasErrors()){
				...
				if(loginVO_chk != null) {
					...
					if(loginVO_chk.getCode().equals("ROLE_ADMIN")) {
						return "/uss/olh/faq/EgovFaqCnUpdt";
					}else if(loginVO_chk.getCode().equals("ROLE_BBS_MANAGER")) {
						return "/uss/olh/faq/EgovFaqCnUpdt";
					}else if(loginVO_chk.getCode().equals("ROLE_ANONYMOUS")) {
						return "/usr/olh/faq/EgovFaqCnUpdt";
					}
				}
    ...
    public String selectFaqListUsr(@ModelAttribute("searchVO") FaqManageDefaultVO searchVO, ModelMap model, HttpServletRequest request) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping("/FaqListDetailInqire.do")
    public String	selectFaqListDetail_user(FaqManageVO faqManageVO,
            @ModelAttribute("searchVO") FaqManageDefaultVO searchVO,
            ModelMap model, HttpServletRequest request) throws Exception {
    ...
    /**
     * 사용자페이지 FAQ 조회수를  수정처리
     * @param faqManageVO
     * @param searchVO
     * @return	"forward:/uss/olh/faq/FaqListDetailInqire.do"
     * @throws Exception
     */
    @RequestMapping("/FaqInqireCoUpdt.do")
    public String updateFaqInqireCo_user(
            FaqManageVO faqManageVO,
            @ModelAttribute("searchVO") FaqManageDefaultVO searchVO)
            throws Exception {
    	LoginVO	loginVO;
        ...
        return "forward:/FaqListDetailInqire.do";
