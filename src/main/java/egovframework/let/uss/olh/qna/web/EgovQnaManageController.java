...
public class EgovQnaManageController {
	...
	public String selectQnaListDetail(@RequestParam("passwordConfirmAt") String passwordConfirmAt,
			QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO, ModelMap model,
			HttpServletRequest request) throws Exception {
	...
	public String insertQnaCn(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
			@ModelAttribute("qnaManageVO") QnaManageVO qnaManageVO, BindingResult bindingResult, ModelMap model)
			throws Exception {
	...
	public String updateQnaCnView(QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
		...
		model.addAttribute(selectQnaListDetail("Y", qnaManageVO, searchVO, model, request));
	...
	public String updateQnaCn(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
			@ModelAttribute("qnaManageVO") QnaManageVO qnaManageVO, BindingResult bindingResult) throws Exception {
	...
	/**
	 * Q&A답변정보를 수정하기 위한 전 처리(공통코드 처리) 관리자, 담당자
	 * 
	 * @param qnaManageVO
	 * @param searchVO
	 * @param model
	...
	/**
	 * 사용자 페이지 Q&A정보 목록을 조회한다. (pageing)
	 * 
	 * @param searchVO
	 * @param model
	 * @return "/uss/olh/qna/EgovQnaListInqire"
	...
	public String selectQnaListUsr(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO, ModelMap model,
			HttpServletRequest request) throws Exception {

		HttpSession session = request.getSession();

		LoginVO loginVO_chk = new LoginVO();
		
		if(session.getAttribute("LoginVO") != null) {
			loginVO_chk = (LoginVO) session.getAttribute("LoginVO");
		}else {
			loginVO_chk.setName("");
		}
		
		String write_nm = loginVO_chk.getName();
		
		
		searchVO.setWrite_nm(write_nm);
		...
		return "/usr/olh/qna/EgovQnaListInqire";

	}

	/**
	 * 사용자페이지 Q&A정보 목록에 대한 상세정보를 조회한다.
	 * 
	 * @param passwordConfirmAt
	 * @param qnaManageVO
	 * @param searchVO
	...
	public String selectQnaListDetailUsr(@RequestParam("passwordConfirmAt") String passwordConfirmAt,
			QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO, ModelMap model,
			HttpServletRequest request) throws Exception {
		...
		return "/usr/olh/qna/EgovQnaDetailInqire";

		/* return "/uss/olh/qna/EgovQnaDetailInqire"; */
	}

	/**
	 * 사용자 페이지 Q&A 조회수를 수정처리한다.
	 * 
	 * @param qnaManageVO
	 * @param searchVO
	 * @return "forward:/uss/olh/qna/QnaDetail.do"
	 * @throws Exception
	 */
	@RequestMapping("/QnaCntUpdt.do")
	public String updateQnaInqireCoUsr(QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/LoginRealnmChoice.do")
	public String selectLoginRealnmChoiceUsr(QnaManageVO qnaManageVO,
			@ModelAttribute("searchVO") QnaManageDefaultVO searchVO, Model model) throws Exception {

		model.addAttribute("QnaManageVO", new QnaManageVO());

		return "/usr/olh/qna/EgovQnaLoginRealnmChoice";
	}

	/**
	 * 사용자 페이지 Q&A정보를 등록하기 위한 전 처리(인증체크)
	 * 
	 * @param searchVO
	 * @param qnaManageVO
	 * @param model
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/QnaCnRegistView.do")
	public String insertQnaCnViewUsr(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO, QnaManageVO qnaManageVO,
			Model model) throws Exception {
		...
		return "/usr/olh/qna/EgovQnaCnRegist";
	...
	public String insertQnaCnUsr(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
			@ModelAttribute("qnaManageVO") QnaManageVO qnaManageVO, BindingResult bindingResult, ModelMap model)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/QnaPasswordConfirmView.do")
	public String selectPasswordConfirmViewUsr(QnaManageVO qnaManageVO,
			@ModelAttribute("searchVO") QnaManageDefaultVO searchVO, Model model) throws Exception {

		model.addAttribute("QnaManageVO", new QnaManageVO());

		return "/usr/olh/qna/EgovQnaPasswordConfirm";
	}

	/**
	 * 사용자 페이지 작성 비밀번호를 확인한다.
	 * 
	 * @param qnaManageVO
	 * @param searchVO
	 * @return "forward:/usr/olh/qna/QnaDetailInqire.do"
	 * @throws Exception
	 */
	@RequestMapping("/QnaPasswordConfirm.do")
	public String selectPasswordConfirmUsr(QnaManageVO qnaManageVO,
			@ModelAttribute("searchVO") QnaManageDefaultVO searchVO, Model model) throws Exception {
		...
		if (searchCnt > 0) { // 작성 비밀번호가 일치하는 경우
			...
			// Q&A를 수정할 수 있는 화면으로 이동.
			return "forward:/QnaCnUpdtView.do";
			...
			// Q&A 상세조회 화면으로 이동.
			return "forward:/QnaDetail.do?passwordConfirmAt=" + passwordConfirmAt;
	...
	/**
	 * 사용자 페이지 Q&A정보를 수정하기 위한 전 처리(비밀번호 암호화)
	 * 
	 * @param qnaManageVO
	 * @param searchVO
	 * @param model
	 * @return "/usr/olh/qna/EgovQnaCnUpdt
	 * @throws Exception
	 */
	@RequestMapping("/QnaCnUpdtView.do")
	public String updateQnaCnViewUsr(QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
			ModelMap model, HttpServletRequest request) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/QnaCnUpdt.do")
	public String updateQnaCnUsr(@ModelAttribute("searchVO") QnaManageDefaultVO searchVO,
			@ModelAttribute("qnaManageVO") QnaManageVO qnaManageVO, BindingResult bindingResult) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/QnaCnDelete.do")
	public String deleteQnaCnUsr(QnaManageVO qnaManageVO, @ModelAttribute("searchVO") QnaManageDefaultVO searchVO)
			throws Exception {
