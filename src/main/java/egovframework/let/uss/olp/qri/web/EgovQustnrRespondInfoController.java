    ...
    throws Exception {
		...
		if(loginVO_chk != null) {
			...
			if(loginVO_chk.getCode().equals("ROLE_ADMIN")) {
				...
				return "/usr/olp/qnn/EgovQustnrRespondInfoManageList";
			}
		}
		...
		String sLocationUrl = "";
		 ...
		 HttpSession session=request.getSession();
			...
			if(loginVO_chk != null) {
				...
				if(loginVO_chk.getCode().equals("ROLE_ADMIN")) {
					sLocationUrl =  "/uss/olp/qnn/EgovQustnrRespondInfoManageRegist";
				}else if(loginVO_chk.getCode().equals("ROLE_BBS_MANAGER")) {
					sLocationUrl =  "/uss/olp/qnn/EgovQustnrRespondInfoManageRegist";
				}else if(loginVO_chk.getCode().equals("ROLE_ANONYMOUS")) {
					sLocationUrl =  "/usr/olp/qnn/EgovQustnrRespondInfoManageRegist";
				}
			}else {
			sLocationUrl = "/usr/olp/qnn/EgovQustnrRespondInfoManageRegist";
			}
