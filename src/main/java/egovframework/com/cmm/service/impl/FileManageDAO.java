...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	/**
	 * 저장된 첨부파일명읠 가져온다. 20191113
	 *
	 * @param fvo
	 * @return
	 * @throws Exception
	 */
	public FileVO selectFileNm(FileVO fvo) throws Exception {
		return (FileVO) select("FileManageDAO.FileNm", fvo);
	}
	 ...
	 * @throws Exception
	 */
	public FileVO selectFileBannerInf(FileVO fvo) throws Exception {
		return (FileVO) select("FileManageDAO.selectFileBannerInf", fvo);
	}
