...
public class EgovFileMngController {
	...
	/**
	 * 사용자 갤럴리게시판  이미지 첨부파일에 대한 목록을 조회한다.
	 *
	 * @param fileVO
	 * @param atchFileId
	 * @param sessionVO
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cmm/fms/selectImageFile.do")
	public String selectImageFile(@ModelAttribute("searchVO") FileVO fileVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
